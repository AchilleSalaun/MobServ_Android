...
public class SimpleLoginActivity extends AppCompatActivity {
    ...
    private void attemptLogin() {
        ...
        Call<String> call_save_contact = GlobalVars.apiService.saveContact(email);
        call_save_contact.enqueue(new Callback<String>() {
            ...
            public void onResponse(Response<String> response, Retrofit retrofit) {
                ...
                GlobalVars.EMAIL_CURRENT_USER = email;

                Intent intent = new Intent(SimpleLoginActivity.this, MainActivity.class);
