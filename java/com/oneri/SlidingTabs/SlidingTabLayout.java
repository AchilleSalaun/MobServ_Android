 ...
 * En gros j'ai juste fait en sorte de changer la couleur de la toolbar
 * en fonction du tab sur lequel on clicke, cela est gere dans le TabClickListener
 *
 * Mais ensuite il faudra peut-etre faire en sorte que les tabs eux-memes changent de
 * couleur (rouge pour les movies, bleu pour le books etc)
 */
